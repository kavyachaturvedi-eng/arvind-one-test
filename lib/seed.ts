...
const STYLE_SPECS: Array<[string, Category, Brand, string, string, number]> = [
  ...
  // A deeper Tommy range: planning screens need enough options to look like a
  // real assortment rather than a sample of one.
  ["Tipped Collar Polo", "Polo", "Tommy Hilfiger", "Green", "#3E6B4F", 3699],
  ["Garment Dye Polo", "Polo", "Tommy Hilfiger", "Rust", "#A65A3A", 3899],
  ["Stripe Jersey Polo", "Polo", "Tommy Hilfiger", "Navy Stripe", "#1D3557", 3999],
  ["Oxford Stripe Shirt", "Shirts", "Tommy Hilfiger", "Blue Stripe", "#4A7FB5", 4399],
  ["Poplin Slim Shirt", "Shirts", "Tommy Hilfiger", "White", "#F2F2EE", 4199],
  ["Flannel Overshirt", "Shirts", "Tommy Hilfiger", "Charcoal Check", "#4A4A48", 5499],
  ["Corduroy Shirt", "Shirts", "Tommy Hilfiger", "Tobacco", "#8B5E3C", 5299],
  ["Flag Crew Tee", "T-Shirts", "Tommy Hilfiger", "White", "#F4F4F0", 2199],
  ["Varsity Graphic Tee", "T-Shirts", "Tommy Hilfiger", "Red", "#B3202C", 2499],
  ["Pique Henley", "T-Shirts", "Tommy Hilfiger", "Grey Melange", "#8E8E88", 2599],
  ["Ryan Relaxed Jean", "Denim", "Tommy Hilfiger", "Light Wash", "#7A9AB8", 6299],
  ["Austin Tapered Jean", "Denim", "Tommy Hilfiger", "Black Rinse", "#1F1F22", 6599],
  ["Cargo Trouser", "Trousers", "Tommy Hilfiger", "Stone", "#B2A98F", 5299],
  ["Pleated Wool Trouser", "Trousers", "Tommy Hilfiger", "Navy", "#22304A", 6999],
  ["Quilted Gilet", "Outerwear", "Tommy Hilfiger", "Black", "#17171A", 8999],
  ["Hooded Windbreaker", "Outerwear", "Tommy Hilfiger", "Cobalt", "#2A5CB8", 9499],
  ["Lambswool Crew", "Knitwear", "Tommy Hilfiger", "Camel", "#C0A171", 6999],
  ["Half-Zip Knit", "Knitwear", "Tommy Hilfiger", "Forest", "#2F4A3A", 7299],
  ["Cotton Cap", "Accessories", "Tommy Hilfiger", "Navy", "#1B2A44", 1799],
  ["Leather Card Holder", "Accessories", "Tommy Hilfiger", "Black", "#1A1A1C", 3499],
