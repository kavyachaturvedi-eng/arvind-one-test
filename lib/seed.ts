...
export const METRICS: MetricDef[] = [
  ...
  },
  {
    ...
    owner: "Retail Planning",
    sources: ["SAP", "D365 POS", "Arvind One"],
    freshness: "hourly",
    ageMinutes: 18,
    replaces: 2,
    verified: true,
...
export const NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    id: "N2",
    at: NOW - 64 * 60_000,
    title: "Price change published in SAP",
...
export const LEGACY_SYSTEMS: LegacySystem[] = [
  ...
  { name: "Vector", role: "Replenishment + IST engine", users: "SCM, planning", pain: "Suggests moves; humans still email to execute them", keep: "keep" },
  ...
  { name: "Capillary", role: "CRM / loyalty", users: "CRM team, stores", pain: "Mobile capture is a manual floor-walk check", keep: "keep" },
  { name: "Omuni", role: "Omni order download and fulfilment", users: "Omni champ", pain: "Separate login, paper omni register", keep: "absorb" },
...
export const SEED_TICKETS: Ticket[] = [
  ...
  },
  {
    ...
    approvalThreshold: 0,
    events: [
      { at: NOW - 64 * 60_000, actor: "SAP", label: "Price change published for 11 styles", system: "SAP" },
...
export const SEED_OMNI: OmniOrder[] = [
  {
    ...
    status: "locating",
    findMinutes: 6,
    events: [{ at: NOW - 40 * 60_000, actor: "Omuni", label: "Routed to store — warehouse out of stock", system: "Omuni" }],
  },
  {
    id: "OM-55022",
    channel: "Myntra",
    ...
    findMinutes: 3,
    events: [
      { at: NOW - 2.4 * HOUR, actor: "Omuni", label: "Routed to store", system: "Omuni" },
  ...
  },
  {
    ...
    podAt: NOW - 3 * HOUR,
    events: [
      { at: NOW - 5 * HOUR, actor: "Omuni", label: "Routed to store", system: "Omuni" },
  ...
  },
  {
    ...
    events: [
      { at: NOW - 27 * HOUR, actor: "Omuni", label: "Routed to store", system: "Omuni" },
  ...
  },
  {
    ...
    events: [
      { at: NOW - 8 * HOUR, actor: "Omuni", label: "Routed to UB City", system: "Omuni" },
  ...
  },
  {
    ...
    events: [
      { at: NOW - 3 * DAY, actor: "Omuni", label: "Routed to store", system: "Omuni" },
      { at: NOW - 3 * DAY + 2 * HOUR, actor: "Delhivery Rider 2210", label: "Digital POD signed", system: "Arvind One" },
      { at: NOW - 10 * HOUR, actor: "Customer", label: "Cancelled after dispatch — return initiated", system: "Omuni" },
